Dataset for a phase space and avalanche size probability distribution in fully coupled network.
...
Data is stored in a structure fc_phase_sp.mat, structure includes following fields:
